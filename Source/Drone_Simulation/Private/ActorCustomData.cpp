...
// Sets default values
AActorCustomData::AActorCustomData()
{
	...
	ElementName = "Cube";
	MaterialType = "No Material";
	InspectionNotes = "Cube";

	/*if (OverlayMaterial.Succeeded())
	{
		UE_LOG(LogTemp, Warning, TEXT("Overlay-MaterialFound"));
		MeshComponent->SetMaterial(1, OverlayMaterial.Object);
	}else if (!OverlayMaterial.Succeeded())
	{
		UE_LOG(LogTemp, Warning, TEXT("Overlay-MaterialNotFound"));
	}*/
	//InfoComponent = CreateDefaultSubobject<AActorCustomData>(TEXT("InfoComponent"));
}



// Called when the game starts or when spawned
void AActorCustomData::BeginPlay()
{
	Super::BeginPlay();
    UE_LOG(LogTemp, Warning, TEXT("ActorCustomData BeginPlay Running"));
...
// Called every frame
void AActorCustomData::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AActorCustomData::SetHighlight(bool bEnable)
{
