...
// Sets default values
AActorCustomData3::AActorCustomData3()
{
	...
	ElementName = "Plane Surface";
	MaterialType = "Basic Color Material";
	InspectionNotes = "Plane Surface";
}

// Called when the game starts or when spawned
void AActorCustomData3::BeginPlay()
{
	Super::BeginPlay();
	UE_LOG(LogTemp, Warning, TEXT("ActorCustomData3 BeginPlay Running"));
...
// Called every frame
void AActorCustomData3::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}
void AActorCustomData3::SetHighlight(bool bEnable)
{
