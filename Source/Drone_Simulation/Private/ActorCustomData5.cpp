...
// Sets default values
AActorCustomData5::AActorCustomData5()
{
 	// Set this actor to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;
	static ConstructorHelpers::FObjectFinder<UStaticMesh> CubeMesh(TEXT("/Engine/BasicShapes/Cylinder.Cylinder"));
	...
	MaterialType = "Charcoal Material";
	InspectionNotes = "Cylinder (Pillar)";

}

// Called when the game starts or when spawned
void AActorCustomData5::BeginPlay()
{
	Super::BeginPlay();
	UE_LOG(LogTemp, Warning, TEXT("ActorCustomData5 BeginPlay Running"));
...
// Called every frame
void AActorCustomData5::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}
void AActorCustomData5::SetHighlight(bool bEnable)
{
