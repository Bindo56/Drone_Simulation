...
// Sets default values
AActorCustomData2::AActorCustomData2()
{
	...
	MaterialType = "Basic Material Metal";
	InspectionNotes = "Simple Triangle";
}

// Called when the game starts or when spawned
void AActorCustomData2::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AActorCustomData2::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}
void AActorCustomData2::SetHighlight(bool bEnable)
{
